...
const topicData=[
 ...
 ['tests','Understanding','Testing fresh inputs','I can explain why passing a sample is not enough.','print(2) can pass one sample but fail an all-fence grid.','b5','Choose a fresh test and explain which mistake it could expose.'],
];
...
export const reportConfig={number:3,title:'From Problem to Submission',date:'22 September 2026',allTasks:tasks,lesson:[...main1,...main2],reviewReport};
