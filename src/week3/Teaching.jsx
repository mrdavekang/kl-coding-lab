...
export function WorkedReasoning({guide}){
 return <div className="mcc-worked-reasoning">
  ...
  {guide.question&&<div className="mcc-understanding"><h4>Check your understanding</h4><p>{guide.question.question}</p><p className="mcc-small">Explain your thinking aloud or to a partner, then compare.</p><details><summary>Read the explanation</summary><p>{guide.question.answer}</p></details></div>}
 </div>;
}
