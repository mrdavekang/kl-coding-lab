...
export function ReportPanel({ profile, work, setWork, busy, onBackup, lessonConfig = null, flat = false }) {
  ...
  return <div className="report-panel">
    ...
    <p className="modal-intro">Keep a record of what you tried, tested and learned. Your PDF includes your code, recent attempts, check results, starting points and {number >= 2 ? 'both learning pit stops, plus your selected walkthrough steps.' : 'learning pit stop.'}{tasks?.some(t=>t.kind==='output')?' Answer-file work is labelled separately from programming.':''}</p>
